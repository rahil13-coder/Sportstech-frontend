...
export default function BasketballPage({ onBackClick }) {
  ...
  return (
    <section style={{ padding: "20px", textAlign: 'center' }}>
      ...
      <h2 className= "basketball"style={{ marginBottom: "12px" }}> BASKETBALL TECHNOLOGIES </h2>

      <button className="btn-view-technologies" onClick={(e) => { setShowTechnologies(true); trackClick('button-view-basketball-technologies', 'button', window.location.pathname); }} style={{ marginBottom: "10px", backgroundColor: "#007bff", color: "white" }}>
      ...
      {showTechnologies && (
        ...
        >
          <button
            onClick={(e) => { setShowTechnologies(false); trackClick('button-basketball-technologies-back', 'button', window.location.pathname); }}
            style={{
              position: "absolute",
              top: "20px",
              left: "80px",
          ...
          <div>
            <button
              ...
              onClick={(e) => { setShowAnalytica(prev => !prev); trackClick('button-basketball-analytica-toggle', 'button', window.location.pathname); }}
              ...
              <>
                <div style={{ marginBottom: 10 }}>
                  ...
                  <button
                    ...
                    onClick={(e) => { handleWebcam(e); trackClick('button-basketball-analytica-use-webcam', 'button', window.location.pathname); }}
                ...
                <div style={{
                  ...
                  {log.length > 0 ? (
                    ...
                    <div>No data yet. Upload a basketball video or use webcam to start analysis.</div>
                  )}
                </div>
              </>
            )}
