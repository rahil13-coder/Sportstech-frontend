...
const COLORS = {
  ...
  return (
    <section style={{ padding: "20px", textAlign: 'center' }}>
      ...
      <h2 className= "tennis"style={{ marginBottom: "12px" }}> Cricket TECHNOLOGIES </h2>
              ...
              <>
                ...
                <div style={{
                  ...
                  {log.length > 0 ? (
                    ...
                    <div>No data yet. Upload a cricket video or use webcam to start analysis.</div>
                  )}
                </div>
              </>
            )}
